...
# train_set = train_label.merge(train_msg_feature, on=['sn', 'fautl_time'], how='left') \
#     .merge(train_venus_feature, on=['sn', 'fautl_time'], how='left') \
#     .merge(train_crashdump_feature, on=['sn', 'fautl_time'], how='left')
